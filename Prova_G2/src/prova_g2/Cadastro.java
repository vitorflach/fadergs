...
public class Cadastro {
    public static void main(String[] args) {
        ...
        do{
            ...
            menu = scanf.nextInt();
            switch(menu){
                case 1: System.out.println("VOCÊ SELECIONOU: CADASTRAR PESSOA");
                        do{
                            System.out.println("Selecione a opão de cadastramento ==> \n1)PF\n2)PJ");
                            opcao = scanf.nextInt();
                            switch(opcao){
                    ...
                    break;
                case 2: System.out.println("VOCÊ SELECIONOU: BUSCAR PESSOA");
                        ...
                        flag = false;
                    break;
                case 3: System.out.println("VOCÊ SELECIONOU: INCREMENTAR IDADE");
                        ...
                        flag = false;
                    break;
                case 4: System.out.println("VOCÊ SELECIONOU: EXCLUIR PESSOA");
                       ...
                       flag = false;
                    break;
                case 5: System.out.println("VOCÊ SELECIONOU: LISTAR PESSOAS");
                        if(pessoas.isEmpty()){
                            System.out.println("---------------------------------------");
                ...
                case 6: if(pessoas.isEmpty()){
                            ...
                            System.out.println("Digite uma idade e o programa irá imprimir na tela todas as pessoas que tem essa idade: ");
                            idade = scanf.nextInt();
                            for(Pessoa p: pessoas){
                                if(p.getIdade() == idade){                                   
                                    System.out.println("---------------------------------------");
                    ...
                    break;
                case 7: System.out.println("PROGRAMA FINALIZADO, ATÉ LOGO.");
                    break;
                default: System.out.println("Opção inválida."); System.out.println("----------------------------------------");
            }
